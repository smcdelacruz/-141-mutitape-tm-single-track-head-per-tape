...
class MultiTapeTM:
    ...
    def is_accepted(self, string_input):
        ...
        while True:
            ...
            if self.state == 'q_reject':  # Halt without swap
                return False
...
if __name__ == '__main__':
    ...
    def get_swap_transitions():
        ...
        for symbol in ['0','1']:
            transitions.append(('q2', ('B',symbol,'B'), 'q2', ('B',symbol,'B'), ('S','L','S')))
        transitions.append(('q2', ('B','B','B'), 'q3', ('B','B','B'), ('L','R','S')))

        # ==== q3 - Find the rightmost symbol of num1 on Tape 1
        for t2 in symbols:
            transitions.append(('q3', ('B',t2,'B'), 'q3', ('B',t2,'B'), ('L','S','S')))
            for symbols in ['0','1']:
                transitions.append(('q3', (symbols,t2,'B'), 'q4', (symbols,t2,'B'), ('L','S','S')))

        # ==== q4 - Find the leftmost B symbol on Tape 1
        for t2 in symbols:
            for symbols in ['0','1']:
                transitions.append(('q4', (symbols,t2,'B'), 'q4', (symbols,t2,'B'), ('L','S','S')))
            transitions.append(('q4', ('B',t2,'B'), 'q5', ('B',t2,'B'), ('R','S','S')))
        ...
        # A > B when second number exhausted
        # If second number exhausted and first number still has 0 or 1 -> treat as A > B
        transitions.append(('q5', ('0','B','B'), 'q6', ('0','B','B'), ('L','L','S')))
        transitions.append(('q5', ('1','B','B'), 'q6', ('1','B','B'), ('L','L','S')))


        # A < B -> NO SWAP
        transitions.append(('q5', ('0','1','B'), 'q_reject', ('0','1','B'), ('S','S','S')))
        transitions.append(('q5', ('B','1','B'), 'q_reject', ('B','1','B'), ('S','S','S')))
        transitions.append(('q5', ('B','B','B'), 'q_reject', ('B','B','B'), ('S','S','S')))

        # ==== q6 - Find the leftmost B symbol on Tape 1 and Tape 2
        for t1 in swap_symbols:
            for t2 in swap_symbols:
                if not (t1 == 'B' and t2 == 'B'):
                    transitions.append(('q6', (t1,t2,'B'), 'q6', (t1,t2,'B'), ('L','L','S')))
        # If both Tape heads point to Blank, move to next state
        transitions.append(('q6', ('B','B','B'), 'q7', ('B','B','B'), ('S','R','R')))

        # ==== q7 - Transfer num2 from Tape 2 to Tape 3 
        # (Tape 3 is temporary tape for copying)
        transitions.append(('q7', ('B','0','B'), 'q7', ('B','B','0'), ('S','R','R')))
        transitions.append(('q7', ('B','1','B'), 'q7', ('B','B','1'), ('S','R','R')))
        transitions.append(('q7', ('B','#','B'), 'q7', ('B','B','B'), ('S','R','R')))
        transitions.append(('q7', ('B','B','B'), 'q8', ('B','B','B'), ('S','L','L')))

        #  ==== q8 - Find the leftmost B symbol on Tapes 2 and 3
        for symbol in ['0','1','#']:
            transitions.append(('q8', ('B','B',symbol), 'q8', ('B','B',symbol), ('S','L','L')))
        ...
        transitions.append(('q9', ('#','B','B'), 'q10', ('B','B','B'), ('L','L','S')))
        transitions.append(('q9', ('B','B','B'), 'q10', ('B','B','B'), ('L','L','S')))

        #  ==== q10 - Find the leftmost B symbol on Tapes 1 and 2
        for symbol in ['0','1','#']:
            transitions.append(('q10', ('B',symbol,'B'), 'q10', ('B',symbol,'B'), ('L','L','S')))
        ...
        transitions.append(('q11', ('B','B','#'), 'q11', ('B','B','B'), ('R','S','R')))
        transitions.append(('q11', ('B','B','B'), 'q_accept', ('B','B','B'), ('S','S','S')))
